...
function Home() {
  ...
  const [active, setActive] = useState({imgelink:"https://images.unsplash.com/photo-1499696010180-025ef6e1a8f9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80",src: "audio1.mp3",
  title: "Audio 1"}
  );
    ...
    <div className="m-10 flex flex-col justify-center items-center gap-4">
      ...
      <div className="grid gap-4">
        <div className="flex flex-col items-center gap-3">
          ...
          <div class="bg-[#F8FAFC] dark:bg-[#0A1122] flex flex-col items-center justify-center">
